...
var UserComponentComponent = /** @class */ (function () {
    function UserComponentComponent(formBuilder, http) {
    ...
    UserComponentComponent.prototype.onSubmit = function (userData) {
        ...
        this.http.post('/userservice/api/v1/users', userData).subscribe(function (data) { return console.log("Saved Info::", data); });
        return;
    };
...
module.exports = __webpack_require__(/*! /home/ashwin/Ashwin/Workspace/practice/springboilerplate/springmicroservice/webapplication/webapp/src/main.ts */"./src/main.ts");
